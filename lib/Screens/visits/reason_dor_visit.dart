...
class resaon_for_visit extends StatefulWidget {
  final String id;
  const resaon_for_visit({Key key,this.id}) : super(key: key);


  @override
  _resaon_for_visitState createState() => _resaon_for_visitState();
}

class _resaon_for_visitState extends State<resaon_for_visit>with TickerProviderStateMixin {
...
Future submit(String patient_name,String Address_f,String gender,String problem_f,String des_problem,var bp,var db,var age,var weight)async{
                ...
                Padding(
                    ...
                    child: InkWell(
                      onTap: ()async{
                        ...
                        submit(name.text,address.text,gender_drop,_mySelection,problem.text,bp.text,diabetics,age.text,weight.text);
