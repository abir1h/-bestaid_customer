    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        floatingActionButton: FloatingActionButton(
          ...
          child: Image.asset('images/floatButton.png',height: 40,width: 40,),
                ...
                MaterialButton(
                  ...
                  child: Column(
                    ...
                    children: [
                      Icon(
                        Icons.home,
                        color: current_tab==0? Color(0xff0E6B50):Colors.grey,
                      ),
                      Text(
                        "Home",
                    ...
                    child: Column(
                      ...
                      children: [
                        Icon(
                          ...
                          color: current_tab==1? Color(0xff0E6B50):Colors.grey,
                        ),
                        Text(
                          "Appointments",
                          style: GoogleFonts.lato(
                  ...
                  child: Column(
                    ...
                    children: [
                      Icon(
                        ...
                        color: current_tab==3? Color(0xff0E6B50):Colors.grey,
                      ),
                      Text(
                        "DHR",
                        style: GoogleFonts.lato(
                ...
                MaterialButton(                    minWidth: 40,
                  ...
                  child: Column(
                    ...
                    children: [
                      Icon(
                        Icons.menu,
                        color: current_tab==2? Color(0xff0E6B50):Colors.grey,
                      ),
                      Text(
                        "Menu",
                        style: GoogleFonts.lato(
