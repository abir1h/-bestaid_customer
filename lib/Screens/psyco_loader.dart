...
class psyco_loader extends StatefulWidget {
  final String patient_id;
  const psyco_loader({Key key,this.patient_id}) : super(key: key);
  @override
  _psyco_loaderState createState() => _psyco_loaderState();
}

class _psyco_loaderState extends State<psyco_loader> {
  Future myfuture;
  var link;
  Future getpost() async {
    ...
    String url = "https://bestaid.com.bd/api/customer/psycho/show/video/doctor/$id";
          ...
          children: [
            ...
            Center(child: Align(alignment:Alignment.center,child: Column(
              children: [
                ...
                Text("Please wait for doctor response",style: GoogleFonts.lato(
                    color: Colors.black,
