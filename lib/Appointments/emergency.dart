...
class emergency_appointments extends StatefulWidget {

  @override
  _emergency_appointmentsState createState() => _emergency_appointmentsState();
}

class _emergency_appointmentsState extends State<emergency_appointments> {
  Future myfuture;
  Future<List<dynamic>> getpost() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    String token = prefs.getString('token');

    String url = "https://bestaid.com.bd/api/customer/show/appointment";
                              ...
                              children: [
                                ListTile(
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      IconButton(icon: Icon(Icons.remove_red_eye_outlined,color: Colors.green,), onPressed: (){
                                        Navigator.push(context, MaterialPageRoute(builder: (_)=>show_details(id:snapshot.data[index]['id'].toString(),type: 'e',)));
                                      }),
                                      IconButton(icon: Icon(Icons.sticky_note_2,color: Colors.blue,), onPressed: (){
                                        Navigator.push(context, MaterialPageRoute(builder: (_)=>pres(id:snapshot.data[index]['id'].toString(),)));
                                      })
