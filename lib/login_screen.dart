...
class _login_screenState extends State<login_screen> {
  ...
  bool issave=false;  bool _showPassword = false;
  var player_id;
  func()async{
  ...
  saveprefs(String token,String first_name,String last_name,String phone)async{
                        ...
                        Row(
                          ...
                          children: [
                            Text("Don't have an account ?",style: GoogleFonts.lato(
                              ...
                              child: Text("SignUp Now",style: GoogleFonts.lato(
                                  color: Colors.green,
                                  fontWeight: FontWeight.w700,
                                  fontSize: 18
                              )),
