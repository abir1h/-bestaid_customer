...
class doctors extends StatefulWidget {
  final String id;
  const doctors({Key key,this.id}) : super(key: key);
  @override
...
class _doctorsState extends State<doctors> {
  ...
  Future<List<dynamic>> getpost() async {
    ...
    String url = "https://bestaid.com.bd/api/customer/show/medical/doctor/$id";
  ...
  _search() async {
    ...
    var id=widget.id;
    Response response =
    await get(Uri.parse("https://bestaid.com.bd/api/customer/search/result/medical/$id/" + controller), headers: requestHeaders);
