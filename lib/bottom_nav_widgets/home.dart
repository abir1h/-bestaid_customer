...
Future medical_home;
  Future<List<dynamic>> specialist_docotr() async {
    ...
    var response = await http.get(Uri.parse('https://bestaid.com.bd/api/customer/show/all/doctor'), headers: requestHeaders);
    if (response.statusCode == 200) {
      print('Get post collected' + response.body);
      var userData1 = jsonDecode(response.body)['data'];
      print(userData1);
                  ...
                  children: [
                    ...
                    InkWell(
                      ...
                      child: Shimmer.fromColors(
                        ...
                        child: Text("Best",style: GoogleFonts.lato(

                            fontWeight: FontWeight.w800,
                            fontSize: 26
                        )),
                      ),
                    ),SizedBox(width:5),Shimmer.fromColors(
                      highlightColor: Color(0xff0E6B50),
                      baseColor: Color(0xffED2D43),
                      child: Text("Aid",style: GoogleFonts.lato(
                          fontWeight: FontWeight.w800,
                          fontSize: 26
                      )),
                    ),
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                            ...
                            children: [
                              Column(
                                ...
                                children: [
                                  Row(
                                    children: [
                                      Icon(Icons.call,color: Color(0xff0E6B50),size: 50,),
                                      Padding(
                                        padding: const EdgeInsets.only(left: 5,bottom: 2),
                                        child: Text("Shunbo!",style: GoogleFonts.roboto(
                                            color: Colors.black,
                                            fontWeight: FontWeight.w800,
                                            fontSize: 24
                                        )),
                                  ...
                                  SizedBox(height: 10,),
                                  Text("Our expert doctors\n can answer all your questions\n over  call",style: GoogleFonts.lato(
                                      color: Colors.grey,
                          ...
                          InkWell(
                            onTap: (){
                              Navigator.push(context, MaterialPageRoute(builder: (_)=>psyco_booking()));
                            ...
                            child: Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Shimmer.fromColors(      highlightColor: Color(0xffED2D43),
                                    baseColor: Color(0xff0E6B50),
                      ...
                      Container(
                        ...
                        child: Image.asset('images/vec.jpg',height: height/6,width:width /2.8,),
                      )
                          ...
                          child: InkWell(
                            ...
                            children: [
                              Container(
                                  ...
                                  child:Icon(Icons.add_to_home_screen,color:Colors.white,size:60)
                              ), Expanded(
                                child: Container(
                                  height: height/8,
                                  decoration: BoxDecoration(
                                  ...
                                  child: Container(
                                    child: Column(
                                      ...
                                      children: [
                                        Text("  Digital Health Records",style: GoogleFonts.roboto(
                                            color: Colors.black,
                                            fontWeight: FontWeight.w800,
                                            fontSize: 18
                                        )),
                                        ...
                                        Padding(padding: EdgeInsets.only(left:8)
                                          ...
                                          ,child:  Text(" Keep your records on cloud and maintain a sound  health ",style: GoogleFonts.lato(
                                              color: Colors.grey,
                                              fontWeight: FontWeight.w700,
                                              fontSize: 14
                                          )),
                        ...
                        Align(
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: [
                                  Text("Department's",style:GoogleFonts.lato(
                                      color: Colors.grey,
                                      fontSize: 18,
                                      fontWeight: FontWeight.w700
                                  ),),InkWell(
                        ...
                        Align(
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: [
                                  Text("Emergency Doctors",style:GoogleFonts.lato(
                                      color: Colors.grey,
                                      fontSize: 18,
                                      fontWeight: FontWeight.w700
                                  ),),InkWell(
                                    onTap: (){
                                      Navigator.push(context, MaterialPageRoute(builder: (_)=>gp_doctor()));
                                      // Fluttertoast.showToast(
                                      //
                                      //     msg: "Service will available very soon!!!",
                                      //     toastLength: Toast.LENGTH_LONG,
                                                                    ...
                                                                    Container(
                                                                      ...
                                                                      child: Column(
                                                                        children: [
                                                                          Container(
                                                                            ...
                                                                            decoration: BoxDecoration(
                                                                                ...
                                                                                image: DecorationImage(
                                                                                    ...
                                                                                    image: NetworkImage(AppUrl.pic_url1+snapshot.data[index]['profile_image'])
                                                                          ...
                                                                          Align(
                                                                              alignment:Alignment.topLeft,
                                                                              child: Text(snapshot.data[0]['type']=='gp'?"General Physician":"Specialist",style: GoogleFonts.lato(
                                                                                  color: Colors.grey,
                                                                                  fontWeight: FontWeight.w600,
                                                                                  fontSize: 12
                                                                              ),)),
                                                                            ...
                                                                            child: Column(
                                                                              ...
                                                                              children: [
                                                                                Align(
                                                                                  ...
                                                                                  alignment:Alignment.topLeft,
                                                                                  child: Text(snapshot.data[index]['experience']+" years",style: GoogleFonts.lato(
                                                                                      color: Colors.black,
                                                                                      fontWeight: FontWeight.w600,
                                                                                      fontSize: 16
                                                                                  )
                        ...
                        Align(
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: [
                                  Text("Specialist Doctors",style:GoogleFonts.lato(
                                      color: Colors.grey,
                                      fontSize: 18,
                                      fontWeight: FontWeight.w700
                                  ),),InkWell(
                                    onTap: (){
                                      Navigator.push(context, MaterialPageRoute(builder: (_)=>sp_doctor()));
                                      // Fluttertoast.showToast(
                                      //
                                      //     msg: "Service will available very soon!!!",
                                      //     toastLength: Toast.LENGTH_LONG,
                                          ...
                                          child:   Container(
                                            ...
                                            child:   ListView.builder(
                                                ...
                                                itemBuilder: (_,index){
                                                  ...
                                                  return snapshot.data[index]['type']=='specialist'?  Row(
                                                    children: [
                                                      InkWell(
                                                        onTap:(){
                                                          Navigator.push(context, MaterialPageRoute(builder: (_)=>doctor_profile(id: snapshot.data[index]['id'].toString(),)));
                                                                  ...
                                                                  Flexible(
                                                                    child: Column(
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Text(snapshot.data[index]['name'],maxLines: 2,overflow: TextOverflow.ellipsis,style:GoogleFonts.lato(

                                                                            color: Colors.black,fontWeight: FontWeight.w700,fontSize: 18
                                                                        )),

                                                                        Text(snapshot.data[index]['degree_obtained'],overflow: TextOverflow.ellipsis,style:GoogleFonts.lato(
                        ...
                        Align(
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: [
                                  Text("Hospitals",style:GoogleFonts.lato(
                                      color: Colors.grey,
                                      fontSize: 18,
                                      fontWeight: FontWeight.w700
                                  ),),InkWell(
                                    onTap: (){
                                      Navigator.push(context, MaterialPageRoute(builder: (_)=>view_all_medical()));
                                      // Fluttertoast.showToast(
                                      //
                                      //     msg: "Service will available very soon!!!",
                                      //     toastLength: Toast.LENGTH_LONG,
                                                        ...
                                                        child: Container(
                                                          ...
                                                          child: Padding(
                                                            ...
                                                            child: Column(
                                                              ...
                                                              mainAxisAlignment: MainAxisAlignment.start,
                                                              children: [
                                                                Icon(Icons.class_,color: Color(0xff0E6B50),),
                                                                Flexible (
                                                                  child: Text(
                                                                      snapshot.data[index]['name'],style:GoogleFonts.lato(

                                                                      color: Color(0xff0E6B50),fontWeight: FontWeight.w600,fontSize: 16
                                                                  )
                                                                  ),
                                                                )
                                                              ],
