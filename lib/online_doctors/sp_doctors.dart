...
class sp_doctor extends StatefulWidget {

  @override
  _sp_doctorState createState() => _sp_doctorState();
}

class _sp_doctorState extends State<sp_doctor> {
  Future myfuture;
  Future<List<dynamic>> getpost() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    String token = prefs.getString('token');

    String url = "https://bestaid.com.bd/api/customer/show/special/doctor/all";
  ...
  _search() async {
    ...
    Response response =
    await get(Uri.parse("https://bestaid.com.bd/api/customer/search/result/specialist/0/" + controller), headers: requestHeaders);
                                                                      ...
                                                                      child: Column(
                                                                        ...
                                                                        children: [
                                                                          Align(
                                                                            ...
                                                                            alignment:Alignment.topLeft,
                                                                            child: Text(snapshot.data[index]['pay_amount'],style: GoogleFonts.lato(
                                                                                color: Colors.black,
                                                                                fontWeight: FontWeight.w600,
                                                                                fontSize: 16
                                                                            )
