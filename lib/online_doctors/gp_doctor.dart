...
class gp_doctor extends StatefulWidget {
 
  @override
  _gp_doctorState createState() => _gp_doctorState();
}

class _gp_doctorState extends State<gp_doctor> {
  Future myfuture;
  Future<List<dynamic>> getpost() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    String token = prefs.getString('token');

    String url = "https://bestaid.com.bd/api/customer/show/gp/doctor/all";
  ...
  void initState() {
    ...
    _stream = _streamController.stream;getdata();
  }
  @override
