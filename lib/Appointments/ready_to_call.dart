...
class ready_to extends StatefulWidget {

  @override
  _ready_toState createState() => _ready_toState();
}

class _ready_toState extends State<ready_to> {
  Future myfuture;
  Future<List<dynamic>> getpost() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    String token = prefs.getString('token');

    String url = "https://bestaid.com.bd/api/customer/show/appointment/ready/to/call";
                                                ...
                                                children: [
                                                  ListTile(
                                                    ...
                                                    Row(
                                                      ...
                                                      children: [
                                                        IconButton(icon: Icon(Icons.video_call,color: Colors.green,), onPressed: (){
                                                          Navigator.push(context, MaterialPageRoute(builder: (_)=>emergency_doctor_loader(patient_id: snapshot.data[index]['id'].toString(),)));
